        ...
        if let Some(data) = data.as_slice() {
            ...
            if let Ok(forza_packet) = parse_forza_packet(&parsed_msgpack.data) {
                let insert_forza_telemetry = ForzaTelemetry {
                    ...
                    tire_slip_ratio_front_right: forza_packet.tire_slip_ratio_front_right,
                    ...
                    wheel_rotation_speed_front_left: forza_packet.wheel_rotation_speed_front_left,
                    wheel_rotation_speed_front_right: forza_packet.wheel_rotation_speed_front_right,
                    wheel_rotation_speed_rear_left: forza_packet.wheel_rotation_speed_rear_left,
                    wheel_rotation_speed_rear_right: forza_packet.wheel_rotation_speed_rear_right,
                    wheel_on_rumble_strip_front_left: forza_packet.wheel_on_rumble_strip_front_left,
                    wheel_on_rumble_strip_front_right: forza_packet
                        .wheel_on_rumble_strip_front_right,
                    wheel_on_rumble_strip_rear_left: forza_packet.wheel_on_rumble_strip_rear_left,
                    wheel_on_rumble_strip_rear_right: forza_packet.wheel_on_rumble_strip_rear_right,
                    wheel_in_puddle_front_left: forza_packet.wheel_in_puddle_front_left,
                    wheel_in_puddle_front_right: forza_packet.wheel_in_puddle_front_right,
                    ...
                    tire_slip_angle_front_right: forza_packet.tire_slip_angle_front_right,
                    ...
                    tire_combined_slip_front_left: forza_packet.tire_combined_slip_front_left,
                    tire_combined_slip_front_right: forza_packet.tire_combined_slip_front_right,
                    tire_combined_slip_rear_left: forza_packet.tire_combined_slip_rear_left,
                    tire_combined_slip_rear_right: forza_packet.tire_combined_slip_rear_right,
