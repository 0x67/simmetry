...
const telemetryStatus = ref<'Connected' | 'Disconnected' | 'Connecting'>(
  'Disconnected'
);

const telemetryStatusColor = ref({
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="col-span-2">
            <h1 class="text-2xl font-bold">
              Telemetry status:
              <span :class="telemetryStatusColor[telemetryStatus]">
                {{ telemetryStatus }}
              </span>
            </h1>
            <button
              class="rounded-sm h-10 w-30 items-center justify-center flex cursor-pointer"
              @click="handleClick"
            >
              <span class="text-5">
                {{
                  telemetryStatus === 'Disconnected' ? 'Connect' : 'Disconnect'
                }}
              </span>
            </button>
          </div>
