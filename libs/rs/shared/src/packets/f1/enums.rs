...
/// a [`MarshalZone`](crate::packets::f1::session::MarshalZone).
/// Represents an [`i8`].
#[non_exhaustive]
#[derive(
    BinRead,
...
/// [`F1PacketSession`](struct@crate::packets::f1::session::F1PacketSession).
/// Represents a [`u8`].
#[non_exhaustive]
#[derive(
    BinRead,
...
/// Safety car deployment status in [`F1PacketSession`](struct@crate::packets::f1::session::F1PacketSession).
/// Represents a [`u8`].
#[non_exhaustive]
#[derive(
    BinRead,
...
/// Accuracy of a
/// [`WeatherForecastSample`](struct@crate::packets::f1::session::WeatherForecastSample).
/// Represents a [`u8`].
#[non_exhaustive]
#[derive(
    BinRead,
...
/// in a [`Buttons` event](variant@crate::packets::f1::event::EventDetails::Buttons).
/// Represents a [`u32`].
...
/// [`SafetyCar` event](variant@crate::packets::f1::event::EventDetails::SafetyCar).
/// Represents a [`u8`].
#[non_exhaustive]
#[derive(
    BinRead,
