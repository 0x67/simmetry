use crate::packets::f1::enums::{MarshalZoneFlag, TemperatureChange, Weather};
use binrw::BinRead;
...
#[derive(BinRead, Eq, PartialEq, Ord, PartialOrd, Copy, Clone, Debug, Serialize, Deserialize)]
#[br(
    little,
    import(_packet_format: u16),
    assert(
...
pub(super) fn get_forecast_samples_padding(packet_format: u16, num_samples: usize) -> usize {
